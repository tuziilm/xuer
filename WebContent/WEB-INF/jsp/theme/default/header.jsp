<%@page import="com.dxj.xuer.common.SystemUserType"%>
<%@page import="com.dxj.xuer.common.LoginContext"%>
        ...
        <div class="container-fluid">
          ...
          <div class="nav-collapse collapse">
            <p class="navbar-text pull-right">
              ${xuer:username()}，您好！ <a href="${basePath}logout" class="navbar-link">退出</a>
            </p>
            <ul class="nav">
              <li class="${_activeArticle}"><a href="${basePath}article/type/list">文章</a></li>
